...
python -m tensorflow_datasets.scripts.download_and_prepare \
    ...
    --datasets=lrs3 \
    --module_import=lrs3_beam \
    --manual_dir=${SRC_DIR} \
    --data_dir=${DST_DIR} \
    --beam_pipeline_options="direct_num_workers=0,direct_running_mode=multi_processing"
    #--debug=True \
    #--debug_start=True \
    #--max_examples_per_split=10 \
    #--beam_pipeline_options="direct_num_workers=0"
    #--beam_pipeline_options="direct_num_workers=0,direct_running_mode=multi_threading"
    #--beam_pipeline_options="direct_num_workers=0,direct_running_mode=multi_processing"
